...
import session.DisponibilidadFacade;
...
@ManagedBean(name = "disponibilidadController")
@SessionScoped
public class DisponibilidadController implements Serializable {

    @EJB
    private session.DisponibilidadFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("DisponibilidadCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("DisponibilidadUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("DisponibilidadDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class DisponibilidadControllerConverter implements Converter {
